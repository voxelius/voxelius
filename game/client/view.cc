...
void view::init(void)
{
    ...
    settings::add_slider(0, settings::VIDEO, "view.max_distance", view::max_distance, 1U, 64U, false);
...
void view::update(void)
{
    ...
    const auto z_far = 1.5f * view::max_distance * static_cast<float>(CHUNK_SIZE);
