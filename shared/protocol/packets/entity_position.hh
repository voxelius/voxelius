...
#ifndef SHARED_PROTOCOL_PACKETS_ENTITY_POSITION_HH
#define SHARED_PROTOCOL_PACKETS_ENTITY_POSITION_HH
...
template<>
inline void protocol::decode_packet<protocol::EntityPosition>(PacketReader &reader, protocol::EntityPosition &packet)
{
...
template<>
inline void protocol::encode_packet<protocol::EntityPosition>(PacketWriter &writer, const protocol::EntityPosition &packet)
{
...
#endif /* SHARED_PROTOCOL_PACKETS_ENTITY_POSITION_HH */
