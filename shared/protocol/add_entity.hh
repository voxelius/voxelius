...
template<>
static inline void protocol::decode_packet<protocol::AddEntity>(PacketReader &reader, protocol::AddEntity &packet)
{
    packet.entity = static_cast<entt::entity>(PacketReader::UI64(reader));
}

template<>
static inline void protocol::encode_packet<protocol::AddEntity>(PacketWriter &writer, const protocol::AddEntity &packet)
{
    PacketWriter::UI64(static_cast<std::uint64_t>(packet.entity));
}

#endif /* SHARED_PROTOCOL_ADD_ENTITY_HH */
