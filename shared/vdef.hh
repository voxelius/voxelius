...
constexpr static const voxel_shape_t VOXEL_SHAPE_NONE   = 0xFFFF;
constexpr static const voxel_shape_t VOXEL_SHAPE_CUBE   = 0x0000;
constexpr static const voxel_shape_t VOXEL_SHAPE_SLAB   = 0x0001;
constexpr static const voxel_shape_t VOXEL_SHAPE_STAIRS = 0x0002;
constexpr static const voxel_shape_t VOXEL_SHAPE_CROSS  = 0x0003;
constexpr static const voxel_shape_t VOXEL_SHAPE_LIQUID = 0x0004;
...
{
void purge();
uint16_t assign(const Identifier &name, uint16_t hint);
VoxelInfo *find(const Identifier &name);
