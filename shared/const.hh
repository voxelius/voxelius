...
constexpr static float ANGLE_90D = cxpr::radians(90.0);
constexpr static float ANGLE_180D = cxpr::radians(180.0);
constexpr static float ANGLE_360D = cxpr::radians(360.0);
