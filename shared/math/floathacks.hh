...
{
inline float int32_to_float(const std::int32_t value);
inline float uint32_to_float(const std::uint32_t value);
inline std::int32_t float_to_int32(const float value);
inline std::uint32_t float_to_uint32(const float value);
} // namespace floathacks
