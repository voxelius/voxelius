...
static bool parse_ascii(TextBuilder &builder, ParserData &parser, const Font &font, char32_t unicode)
{
    ...
    if(unicode == ASCII_LF) {
        ...
        builder.cursor_y += font.lmetrics.lineGap;
        return true;
    }
...
static bool parse_vt241(TextBuilder &builder, ParserData &parser, const Font &font, char32_t unicode)
{
    // Start sequence
...
static bool parse_notch(TextBuilder &builder, ParserData &parser, const Font &font, char32_t unicode)
{
...
void TextBuilder::append(TextBuilder &builder, const Font &font, const std::string &text)
{
    ParserData parser = {};
    std::mbstate_t state = {};
