...
constexpr static const unsigned int SCREEN_SETTINGS_MAIN = 3U;
constexpr static const unsigned int SCREEN_SETTINGS_CONTROLS = 4U;
constexpr static const unsigned int SCREEN_SETTINGS_GRAPHICS = 5U;
} // namespace ui
