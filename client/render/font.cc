...
bool Font::load_image(const vfs::path_t &path, int width, int height)
{
    Image image = {};
...
bool Font::load_vga_rom(const vfs::path_t &path, int width, int height)
{
...
int Font::get_glyph_width() const
{
    return glyph_width;
}
...
int Font::get_texture_cwidth() const
{
    return texture_cwidth;
}

int Font::get_texture_cheight() const
{
    return texture_cheight;
}

const gl::Texture2D &Font::get() const
{
    return texture;
}
