...
{
    GLuint vert = util::compile_shader("shaders/text_quad.vert", GL_VERTEX_SHADER);
    GLuint frag = util::compile_shader("shaders/text_quad.frag", GL_FRAGMENT_SHADER);
...
void text_renderer::draw(float xpos, float ypos, const Font &font, const TextVBO &text, float scale, bool shadow)
{
