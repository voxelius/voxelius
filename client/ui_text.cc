...
void ui::Text::set(int line, const std::string &value)
{
    std::vector<uint32_t> pixels = {};
...
void ui::Text::set(int line, const std::wstring &value)
{
    std::vector<uint32_t> pixels = {};
    pixels.resize(texture_width, 0xFFFFFFFF);
...
int ui::Text::get_max_text_width() const
{
    return max_text_width;
}

int ui::Text::get_max_text_height() const
{
    return max_text_height;
}

int ui::Text::get_texture_width() const
{
    return texture_width;
}

int ui::Text::get_texture_height() const
{
    return texture_height;
}

const gl::Texture2D &ui::Text::get() const
{
    return texture;
}
